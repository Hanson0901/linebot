...
line_bot_api = LineBotApi('88Lnj9pvFPA3IZh1fbQ2FDVmEzXPwd1WZ+5DEaGkdjVOQqi0XOuC63MJ8i4pXfd5Sa3LeFbRc0+wqMCzvY0if4xF/5wPkQFqV1Mvzqj6JV9tO0ttQUVYiVlGe1wSfrVka3NWgPNBMkU/25IewK6H6QdB04t89/1O/w1cDnyilFU=')
...
try:
    ...
    # 上傳 Rich Menu 圖片
    with open('./htdocs/linebot/richmenu.png', 'rb') as f:
